  ...
  return (
    <div class="carousel relative rounded relative overflow-hidden mt-20 px-32">
      <div class="carousel-inner relative overflow-hidden ">
        ...
        />
        <div
          class="carousel-item  absolute opacity-0 bg-center px-64 "
          style={{
            height: 500,
          }}
        >
      ...
      "
        ...
        <div
          ...
          style={{
            height: 500,
            backgroundImage: `url(https://mdbootstrap.com/img/new/slides/043.jpg)`,
          }}
        ></div>
        <label
          for="carousel-1"
      ...
      "
        ...
        />
        <div
          class="carousel-item absolute opacity-0 px-64 bg-center"
          style={{
            height: 500,
          }}
        >
          <img className="" src={slide2} />
        </div>
        <label
          for="carousel-2"
          class="
