          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 ">
            <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <>
                      <Popover.Button
                        className={classNames(
                          open ? "text-input-gray" : "text-input-gray",
                          "group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        )}
                      >
                        <Link to="/nfc/ürün"> Ürünler</Link>
                        <ChevronDownIcon
                          className={classNames(
              ...
              <div className=" md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                <a
                  href="#"
                  className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-roboto font-medium text-white bg-janus-site-blue hover:bg-indigo-700"
                >
                  Kaydol
                </a>
              </div>
