      ...
      {({ open }) => (
        <>
          ...
          <div className="relative mt-1">
            <span className="inline-block w-full rounded-md shadow-input">
              <Listbox.Button className=" flex cursor-default relative w-full rounded-md border border-gray-300 bg-white pl-3 pr-10 py-2 text-left  transition ease-in-out duration-150">
