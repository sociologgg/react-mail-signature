                ...
                {signatureExist ? (
                  ...
                  <div class=" flex flex-col  justify-center w-3/4  px-16  h-100%  ">
                    ...
                    <div className="w-100% flex justify-center">
                      <img src={questionLogo} className="w-218px h-auto" />
                    </div>
                    <p class="font-roboto text-40px font-bold text-janus-dark-blue pt-20px">
                      İmzanızı Bulamadık :(
                    </p>
                  </div>
                )}
          ...
          <div class="h-screen w-screen  flex z-10 relative items-center  justify-center bg-janus-site-blue px-8">
            <div class="w-screen h-100%  ">
              ...
              {signatureExist ? (
                ...
                <div class=" flex flex-col  justify-center w-100%  pt-10px     ">
                  {" "}
                  <div className="w-100% flex justify-center">
                    <img src={questionLogo} className="w-218px h-auto" />
                  </div>
                  <p class="font-roboto text-28px font-bold text-white pt-16px">
                    İmzanızı Bulamadık :(
                  </p>
                </div>
              )}
          ...
          <div class="h-screen w-screen  flex z-10 relative justify-center bg-janus-site-blue">
            <div class="w-screen h-100%  ">
              ...
              {signatureExist ? (
                ...
                <div>SIGNATURE DOES NOT EXIST</div>
              )}
            </div>
          </div>
        </MediaQuery>
