...
querySnapshot.forEach((doc) => {
  ...
  <div className="px-60px">
          ...
          <p className="mt-36px">Henüz organizasyonun adına e-posta imzası oluşturmadın.    <br /> Hadi tasarımını tamamla ve linklere bu sayfadan kolayca ulaş!</p>
          </div> :
          <div className="">
          <div className="flex justify-between  items-center"><p className="text-left text-16px text-input-gray">Organizasyonların adına oluşturduğun e-posta imzası <br /> linklerine bu sayfadan ulaşabilirsin. Kendi mail imzanı <br /> oluşturmak ve linki ekip arkadaşlarınla paylaşmak için  <br /> linki manuel olarak veya ‘’Linki Kopyala’’ butonu ile <br /> kopyalayabilirsin.
            </p>
         ...
         userlinks.map((value,index)=><div className="pb-50px  mt-20px  text-left"> <p> <a className="text-16px font-medium">Organizasyon Adı:</a> <a className="font-normal ml-4px">{value.data().sirketAdi}</a></p>
  ...
  return (
    <div className=" flex justify-center">
      ...
      <div
        class={
          popUpValue == 0 && popUpValue3 == 0 && popUpValue4 == 0 && popUpValue6 == 0
      ...
      >
        <div class="w-screen h-100% flex flex-col   ">
          <div class="flex  justify-between items-center">
            ...
            <div class="mt-2">
              <DropAcc setPopUpValue={()=>{setPopUpValue6(1); console.log('as')}} />
            </div>
          </div>
