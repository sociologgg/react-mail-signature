          ...
          <div class=" flex-column absolute   p-20px z-20 shadow-2xl  rounded-3xl overflow-hidden bg-white mt-64  justify-center ">
            ...
            <div class=" mt-36px  pb-40px ">
              <p class="font-roboto font-light text-16px px-60px">
                Premium planda sınırsız şablona erişebileceksin.<br/> Alternatif
  ...
  <button onClick={()=> navigator.clipboard.writeText('http://localhost:3000/1jTuTrmisjdZuH1bEIUj')}
        ...
        return (
          <div class=" flex-column absolute max-w-470px   p-20px pb-40px z-20 shadow-2xl  rounded-3xl overflow-hidden bg-white mt-64  justify-center ">
            ...
            <div class=" mt-36px  px-40px  flex justify-center items-center ">
              ...
              E-posta imzası tasarımınızı admin olarak şirket adına oluşturdunuz. Ekip arkadaşlarınızın kişisel bilgilerini doldurması için linki paylaşmalısınız!
              </p>
            </div>
      ...
      if (page == 0) {
        ...
        return (
          <div className="w-100% relative flex justify-center">
            ...
            className="pl-20px focus:outline-none py-20px flex items-center"><img src={arrow} className="w-7px    h-14px"/> <p className="ml-10px">Geri </p></button></div>
              ...
              <div>
                ...
                <div class=" flex-col pl-34px">
                  <div class="flex justify-start">
                    <p class="text-janus-dark-blue  text-18px font-roboto">Fotoğraf yükle</p>
                  </div>
                  <div class="flex  justify-start lg:mt-18px">
                    <p class="leading-3 text-14px font-light text-input-gray text-left">
                    Kare formatta maximum 80x80 pixsel<br/> png veya jpeg görsel kullanın
                    </p>
                  </div>
